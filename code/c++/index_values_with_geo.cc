...
void index(const string & datapath, const string & dbpath)
{
    ...
    const size_t FIELD_MIDLAT = 9;
    const size_t FIELD_MIDLON = 10;
	...
	fields.at(FIELD_MIDLAT) != "midlat" ||
	fields.at(FIELD_MIDLON) != "midlon") {
...
// Start of example code.
	const string& midlat = fields.at(FIELD_MIDLAT);
	const string& midlon = fields.at(FIELD_MIDLON);
	if (!midlat.empty() && !midlon.empty())
	    doc.add_value(4, midlat + "," + midlon);
// End of example code.
