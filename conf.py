...
copyright = u'2003-2026 ' + _authors

github_project_url = 'https://github.com/xapian/xapian-docsprint/blob/main'
...
exclude_patterns = ['README.rst', '_build', 'attic', 'language_specific']
