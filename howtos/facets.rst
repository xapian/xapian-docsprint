...
* Multiple values in slots: this will allow you to have a single value slot
  ...
  .. todo:: This is misleading - it's already possibly to deal with a
            facet with multiple values like this.  We should document
            how rather than seeming to imply you can't currently.
